...
.method private static getCause(I)Ljava/lang/String;
    ...
    :sswitch_0
    const-string/jumbo v0, "There was no new data to return."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_2
    const-string/jumbo v0, "Authentication credentials (https://dev.twitter.com/pages/auth) were missing or incorrect. Ensure that you have set valid consumer key/secret, access token/secret, and the system clock is in sync."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_3
    const-string/jumbo v0, "The request is understood, but it has been refused. An accompanying error message will explain why. This code is used when requests are being denied due to update limits (https://support.twitter.com/articles/15364-about-twitter-limits-update-api-dm-and-following)."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_4
    const-string/jumbo v0, "The URI requested is invalid or the resource requested, such as a user, does not exists. Also returned when the requested format is not supported by the requested method."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_5
    const-string/jumbo v0, "Returned by the Search API when an invalid format is specified in the request.\nReturned by the Streaming API when one or more of the parameters are not suitable for the resource. The track parameter, for example, would throw this error if:\n The track keyword is too long or too short.\n The bounding box specified is invalid.\n No predicates defined for filtered resource, for example, neither track nor follow parameter defined.\n Follow userid cannot be read."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_6
    const-string/jumbo v0, "Returned by the Search and Trends API when you are being rate limited (https://dev.twitter.com/docs/rate-limiting).\nReturned by the Streaming API:\n Too many login attempts in a short period of time.\n Running too many copies of the same application authenticating with the same account name."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_7
    const-string/jumbo v0, "Returned when an image uploaded to POST account/update_profile_banner(https://dev.twitter.com/docs/api/1/post/account/update_profile_banner) is unable to be processed."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_8
    const-string/jumbo v0, "Returned in API v1.1 when a request cannot be served due to the application\'s rate limit having been exhausted for the resource. See Rate Limiting in API v1.1.(https://dev.twitter.com/docs/rate-limiting/1.1)"
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_9
    const-string/jumbo v0, "Something is broken. Please post to the group (https://dev.twitter.com/docs/support) so the Twitter team can investigate."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_a
    const-string/jumbo v0, "Twitter is down or being upgraded."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_b
    const-string/jumbo v0, "The Twitter servers are up, but overloaded with requests. Try again later."
    ...
    .end local v0    # "cause":Ljava/lang/String;
    :sswitch_c
    const-string/jumbo v0, "The Twitter servers are up, but the request couldn\'t be serviced due to some failure within our stack. Try again later."
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ", rateLimitStatus="
    ...
    const-string/jumbo v2, "exceptionCode=["
