...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 55
    const-class v5, Ltwitter4j/Query;
    ...
    const-string/jumbo v6, "createWithNextPageQuery"
    ...
    .line 59
    sget-object v5, Ltwitter4j/internal/json/QueryResultJSONImpl;->queryFactoryMethod:Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v7, "twitter4j.Query.createWithNextPageQuery(java.lang.String)"

    invoke-direct {v6, v7}, Ljava/lang/NoSuchMethodException;-><init>(Ljava/lang/String;)V

    invoke-direct {v5, v6}, Ljava/lang/ExceptionInInitializerError;-><init>(Ljava/lang/Throwable;)V
...
.method constructor <init>(Ltwitter4j/internal/http/HttpResponse;Ltwitter4j/conf/Configuration;)V
    ...
    :try_start_0
    const-string/jumbo v6, "search_metadata"
    ...
    const-string/jumbo v6, "completed_in"
    ...
    .line 76
    const-string/jumbo v6, "next_results"
    ...
    .line 78
    const-string/jumbo v6, "refresh_url"
    ...
    .line 81
    const-string/jumbo v6, "statuses"
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-wide v5, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->completedIn:D
    ...
    .line 197
    :cond_4
    iget-wide v3, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->maxId:J
    ...
    .line 199
    :cond_6
    iget-wide v3, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->sinceId:J
...
.method public hashCode()I
    ...
    .line 213
    iget-wide v5, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->sinceId:J

    iget-wide v7, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->sinceId:J
    ...
    iget-wide v5, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->maxId:J

    iget-wide v7, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->maxId:J
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, "QueryResultJSONImpl{sinceId="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-wide v1, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->sinceId:J
    ...
    iget-wide v1, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->maxId:J

    invoke-virtual {v0, v1, v2}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string/jumbo v1, ", refreshUrl=\'"
    ...
    const-string/jumbo v1, ", completedIn="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-wide v1, p0, Ltwitter4j/internal/json/QueryResultJSONImpl;->completedIn:D
