...
.method static createTrendsList(Ltwitter4j/internal/http/HttpResponse;Z)Ltwitter4j/ResponseList;
    ...
    :try_start_0
    const-string/jumbo v10, "as_of"

    invoke-virtual {v3, v10}, Ltwitter4j/internal/org/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-static {v10}, Ltwitter4j/internal/json/z_T4JInternalParseUtil;->parseTrendsDate(Ljava/lang/String;)Ljava/util/Date;

    move-result-object v1

    .line 106
    .local v1, "asOf":Ljava/util/Date;
    const-string/jumbo v10, "trends"
    ...
    invoke-static {v3, p1}, Ltwitter4j/internal/json/TrendsJSONImpl;->extractLocation(Ltwitter4j/internal/org/json/JSONObject;Z)Ltwitter4j/Location;
    ...
    invoke-direct {v7, v10, p0}, Ltwitter4j/internal/json/ResponseListImpl;-><init>(ILtwitter4j/internal/http/HttpResponse;)V
    ...
    invoke-static {v0, p1}, Ltwitter4j/internal/json/TrendsJSONImpl;->jsonArrayToTrendArray(Ltwitter4j/internal/org/json/JSONArray;Z)[Ltwitter4j/Trend;
    ...
    .line 116
    new-instance v10, Ltwitter4j/internal/json/TrendsJSONImpl;

    const-string/jumbo v11, "yyyy-MM-dd HH:mm:ss"

    invoke-static {v5, v11}, Ltwitter4j/internal/json/z_T4JInternalParseUtil;->getDate(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Date;

    move-result-object v11

    invoke-direct {v10, v1, v6, v11, v8}, Ltwitter4j/internal/json/TrendsJSONImpl;-><init>(Ljava/util/Date;Ltwitter4j/Location;Ljava/util/Date;[Ltwitter4j/Trend;)V
...
.method private static extractLocation(Ltwitter4j/internal/org/json/JSONObject;Z)Ltwitter4j/Location;
    ...
    invoke-static {v3, p1}, Ltwitter4j/internal/json/LocationJSONImpl;->createLocationList(Ltwitter4j/internal/org/json/JSONArray;Z)Ltwitter4j/ResponseList;
    :try_end_0
    .catch Ltwitter4j/internal/org/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "locations can\'t be null"
...
.method init(Ljava/lang/String;Z)V
    ...
    const-string/jumbo v4, "No trends found on the specified woeid"
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, "TrendsJSONImpl{asOf="
