...
.method protected getConnection(Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    const-string/jumbo v4, "Proxy AuthUser: "
    ...
    const-string/jumbo v4, "Proxy AuthPassword: "
    ...
    const-string/jumbo v4, "Opening proxied connection("
...
.method public request(Ltwitter4j/internal/http/HttpRequest;)Ltwitter4j/internal/http/HttpResponse;
    ...
    const-string/jumbo v28, "----Twitter4J-upload"
    ...
    const-string/jumbo v27, "Content-Type"

    new-instance v28, Ljava/lang/StringBuilder;

    invoke-direct/range {v28 .. v28}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v29, "multipart/form-data; boundary="
    ...
    const-string/jumbo v28, "Content-Disposition: form-data; name=\""
    ...
    .local v5, "buff":[B
    :goto_3
    invoke-virtual {v10, v5}, Ljava/io/BufferedInputStream;->read([B)I
    ...
    invoke-virtual {v0, v5, v1, v14}, Ljava/io/DataOutputStream;->write([BII)V
    :try_end_0
    ...
    .line 117
    const-string/jumbo v27, "Content-Type: text/plain; charset=UTF-8\r\n\r\n"
    ...
    const-string/jumbo v28, "application/x-www-form-urlencoded"
    ...
    const-string/jumbo v28, "Post Params: "
    ...
    .line 132
    .local v6, "bytes":[B
    const-string/jumbo v27, "Content-Length"
    ...
    const-string/jumbo v29, "Sleeping "
    ...
    const-string/jumbo v29, " seconds until the next retry."
