...
.method public getOAuth2Token()Ltwitter4j/auth/OAuth2Token;
    ...
    const-string/jumbo v3, "OAuth 2 Bearer Token is already available."
    ...
    const-string/jumbo v3, "Obtaining OAuth 2 Bearer Token failed."
...
.method public invalidateOAuth2Token()V
    ...
    const-string/jumbo v5, "OAuth 2 Bearer Token is not available."
    ...
    .line 92
    iget-object v4, p0, Ltwitter4j/auth/OAuth2Authorization;->http:Ltwitter4j/internal/http/HttpClientWrapper;
    ...
    invoke-virtual {v4, v5, v1, p0}, Ltwitter4j/internal/http/HttpClientWrapper;->post(Ljava/lang/String;[Ltwitter4j/internal/http/HttpParameter;Ltwitter4j/auth/Authorization;)Ltwitter4j/internal/http/HttpResponse;
    ...
    const-string/jumbo v5, "Invalidating OAuth 2 Bearer Token failed."

    invoke-direct {v4, v5, v2}, Ltwitter4j/TwitterException;-><init>(Ljava/lang/String;Ltwitter4j/internal/http/HttpResponse;)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, "OAuth2Authorization{consumerKey=\'"
