...
.method public addSerializer(Lorg/codehaus/jackson/map/JsonSerializer;)V
    ...
    const-string/jumbo v3, " does not define valid handledType() -- must either register with method that takes type argument "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, " or make serializer extend \'org.codehaus.jackson.map.ser.std.SerializerBase\'"
