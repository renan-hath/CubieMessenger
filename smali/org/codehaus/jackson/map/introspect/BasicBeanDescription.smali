...
.method public static forDeserialization(Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;)Lorg/codehaus/jackson/map/introspect/BasicBeanDescription;
    .locals 5
    .param p0, "coll"    # Lorg/codehaus/jackson/map/introspect/POJOPropertiesCollector;
...
.method public _findPropertyFields(Ljava/util/Collection;Z)Ljava/util/LinkedHashMap;
    ...
    .line 544
    .local v4, "results":Ljava/util/LinkedHashMap;, "Ljava/util/LinkedHashMap<Ljava/lang/String;Lorg/codehaus/jackson/map/introspect/AnnotatedField;>;"
    iget-object v5, p0, Lorg/codehaus/jackson/map/introspect/BasicBeanDescription;->_properties:Ljava/util/List;
    ...
    check-cast v3, Lorg/codehaus/jackson/map/BeanPropertyDefinition;

    .line 545
    .local v3, "property":Lorg/codehaus/jackson/map/BeanPropertyDefinition;
    invoke-virtual {v3}, Lorg/codehaus/jackson/map/BeanPropertyDefinition;->getField()Lorg/codehaus/jackson/map/introspect/AnnotatedField;
    ...
    .line 547
    invoke-virtual {v3}, Lorg/codehaus/jackson/map/BeanPropertyDefinition;->getName()Ljava/lang/String;
    ...
    .end local v3    # "property":Lorg/codehaus/jackson/map/BeanPropertyDefinition;
    :cond_2
    return-object v4
.end method
...
.method public findGetters(Lorg/codehaus/jackson/map/introspect/VisibilityChecker;Ljava/util/Collection;)Ljava/util/LinkedHashMap;
    ...
    .line 571
    .local v4, "results":Ljava/util/LinkedHashMap;, "Ljava/util/LinkedHashMap<Ljava/lang/String;Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;>;"
    iget-object v5, p0, Lorg/codehaus/jackson/map/introspect/BasicBeanDescription;->_properties:Ljava/util/List;
    ...
    .line 572
    .local v3, "property":Lorg/codehaus/jackson/map/BeanPropertyDefinition;
    invoke-virtual {v3}, Lorg/codehaus/jackson/map/BeanPropertyDefinition;->getGetter()Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;

    move-result-object v1

    .line 573
    .local v1, "m":Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;
    if-eqz v1, :cond_0
    ...
    .line 583
    .end local v1    # "m":Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;
    .end local v2    # "name":Ljava/lang/String;
    .end local v3    # "property":Lorg/codehaus/jackson/map/BeanPropertyDefinition;
    :cond_2
    return-object v4
...
.method public findSerializationInclusion(Lorg/codehaus/jackson/map/annotate/JsonSerialize$Inclusion;)Lorg/codehaus/jackson/map/annotate/JsonSerialize$Inclusion;
    ...
    .line 471
    .end local p1    # "defValue":Lorg/codehaus/jackson/map/annotate/JsonSerialize$Inclusion;
    :goto_0
    return-object p1

    .restart local p1    # "defValue":Lorg/codehaus/jackson/map/annotate/JsonSerialize$Inclusion;
    :cond_0
    iget-object v0, p0, Lorg/codehaus/jackson/map/introspect/BasicBeanDescription;->_annotationIntrospector:Lorg/codehaus/jackson/map/AnnotationIntrospector;
...
.method public findSetters(Lorg/codehaus/jackson/map/introspect/VisibilityChecker;)Ljava/util/LinkedHashMap;
    ...
    .line 591
    .local v3, "results":Ljava/util/LinkedHashMap;, "Ljava/util/LinkedHashMap<Ljava/lang/String;Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;>;"
    iget-object v4, p0, Lorg/codehaus/jackson/map/introspect/BasicBeanDescription;->_properties:Ljava/util/List;
    ...
    .line 592
    .local v2, "property":Lorg/codehaus/jackson/map/BeanPropertyDefinition;
    invoke-virtual {v2}, Lorg/codehaus/jackson/map/BeanPropertyDefinition;->getSetter()Lorg/codehaus/jackson/map/introspect/AnnotatedMethod;
