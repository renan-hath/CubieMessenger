...
.method protected _resolveManagedReferenceProperty(Lorg/codehaus/jackson/map/DeserializationConfig;Lorg/codehaus/jackson/map/deser/SettableBeanProperty;)Lorg/codehaus/jackson/map/deser/SettableBeanProperty;
    ...
    const-string/jumbo v4, "\': value deserializer is of type ContainerDeserializerBase, but content type is not handled by a BeanDeserializer "

    invoke-virtual {v2, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v4, " (instead it\'s of type "
    ...
    const-string/jumbo v4, "Can not handle managed/back reference for abstract types (property "
    ...
    const-string/jumbo v4, "\': type for value deserializer is not BeanDeserializer or ContainerDeserializerBase, but "
...
.method public resolve(Lorg/codehaus/jackson/map/DeserializationConfig;Lorg/codehaus/jackson/map/DeserializerProvider;)V
    ...
    const-string/jumbo v18, "Invalid delegate-creator definition for "
    ...
    const-string/jumbo v18, ": value instantiator ("
    ...
    const-string/jumbo v18, ") returned true for \'canCreateUsingDelegate()\', but null for \'getDelegateType()\'"
