...
.method protected _findRootDeserializer(Lorg/codehaus/jackson/map/DeserializationConfig;Lorg/codehaus/jackson/type/JavaType;)Lorg/codehaus/jackson/map/JsonDeserializer;
    ...
    const-string/jumbo v3, "No value type configured for ObjectReader"
...
.method protected _unwrapAndDeserialize(Lorg/codehaus/jackson/JsonParser;Lorg/codehaus/jackson/map/DeserializationContext;Lorg/codehaus/jackson/type/JavaType;Lorg/codehaus/jackson/map/JsonDeserializer;)Ljava/lang/Object;
    ...
    const-string/jumbo v4, "Current token not START_OBJECT (needed to unwrap root name \'"
    ...
    const-string/jumbo v4, "Current token not FIELD_NAME (to contain expected root name \'"
    ...
    const-string/jumbo v4, "Root name \'"
    ...
    const-string/jumbo v4, "\' does not match expected (\'"
    ...
    const-string/jumbo v4, "\') for type "
    ...
    const-string/jumbo v4, "Current token not END_OBJECT (to match wrapper object with root name \'"
