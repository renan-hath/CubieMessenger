...
.method protected findFilter(Lorg/codehaus/jackson/map/SerializerProvider;)Lorg/codehaus/jackson/map/ser/BeanPropertyFilter;
    ...
    .prologue
    .line 229
    iget-object v1, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_propertyFilterId:Ljava/lang/Object;
...
.method public getSchema(Lorg/codehaus/jackson/map/SerializerProvider;Ljava/lang/reflect/Type;)Lorg/codehaus/jackson/JsonNode;
    ...
    invoke-virtual {p0, v9, v10}, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->createSchemaNode(Ljava/lang/String;Z)Lorg/codehaus/jackson/node/ObjectNode;
    ...
    .local v1, "i":I
    :goto_0
    iget-object v9, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_props:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
...
.method public resolve(Lorg/codehaus/jackson/map/SerializerProvider;)V
    ...
    .prologue
    .line 281
    iget-object v9, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_filteredProps:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
    ...
    .line 315
    instance-of v9, v4, Lorg/codehaus/jackson/map/ser/std/ContainerSerializerBase;

    if-eqz v9, :cond_5

    .line 318
    check-cast v4, Lorg/codehaus/jackson/map/ser/std/ContainerSerializerBase;

    .end local v4    # "ser":Lorg/codehaus/jackson/map/JsonSerializer;, "Lorg/codehaus/jackson/map/JsonSerializer<Ljava/lang/Object;>;"
    invoke-virtual {v4, v7}, Lorg/codehaus/jackson/map/ser/std/ContainerSerializerBase;->withValueTypeSerializer(Lorg/codehaus/jackson/map/TypeSerializer;)Lorg/codehaus/jackson/map/ser/std/ContainerSerializerBase;
    ...
    :cond_6
    iget-object v9, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_anyGetterWriter:Lorg/codehaus/jackson/map/ser/AnyGetterWriter;
...
.method protected serializeFields(Ljava/lang/Object;Lorg/codehaus/jackson/JsonGenerator;Lorg/codehaus/jackson/map/SerializerProvider;)V
    ...
    .prologue
    .line 140
    iget-object v7, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_filteredProps:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
    ...
    .line 141
    iget-object v6, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_filteredProps:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
    ...
    :cond_1
    iget-object v6, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_props:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
    ...
    :cond_2
    :try_start_1
    iget-object v7, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_anyGetterWriter:Lorg/codehaus/jackson/map/ser/AnyGetterWriter;
    ...
    :goto_3
    invoke-virtual {p0, p3, v0, p1, v4}, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->wrapAndThrow(Lorg/codehaus/jackson/map/SerializerProvider;Ljava/lang/Throwable;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v7, v0}, Lorg/codehaus/jackson/map/JsonMappingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected serializeFieldsFiltered(Ljava/lang/Object;Lorg/codehaus/jackson/JsonGenerator;Lorg/codehaus/jackson/map/SerializerProvider;)V
    ...
    .prologue
    .line 186
    iget-object v8, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_filteredProps:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
    ...
    :cond_1
    iget-object v7, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_props:[Lorg/codehaus/jackson/map/ser/BeanPropertyWriter;
    ...
    :cond_4
    iget-object v8, p0, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->_anyGetterWriter:Lorg/codehaus/jackson/map/ser/AnyGetterWriter;
    ...
    :goto_3
    invoke-virtual {p0, p3, v0, p1, v5}, Lorg/codehaus/jackson/map/ser/std/BeanSerializerBase;->wrapAndThrow(Lorg/codehaus/jackson/map/SerializerProvider;Ljava/lang/Throwable;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v4, v8, v0}, Lorg/codehaus/jackson/map/JsonMappingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
