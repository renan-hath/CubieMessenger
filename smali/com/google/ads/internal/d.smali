...
.method public constructor <init>(Lcom/google/ads/Ad;Landroid/app/Activity;Lcom/google/ads/AdSize;Ljava/lang/String;Landroid/view/ViewGroup;Z)V
    ...
    const-string/jumbo v3, "GoogleAdMobAdsPrefs"
...
.method private a(Lcom/google/ads/f;Ljava/lang/Boolean;)V
    ...
    .line 819
    const-string/jumbo v0, "http://e.admob.com/imp?ad_loc=@gw_adlocid@&qdata=@gw_qdata@&ad_network_id=@gw_adnetid@&js=@gw_sdkver@&session_id=@gw_sessid@&seq_num=@gw_seqnum@&nr=@gw_adnetrefresh@&adt=@gw_adt@&aec=@gw_aec@"
...
.method private a(Ljava/util/List;Ljava/lang/String;)V
    ...
    .line 874
    const-string/jumbo v0, "http://e.admob.com/nofill?ad_loc=@gw_adlocid@&qdata=@gw_qdata@&js=@gw_sdkver@&session_id=@gw_sessid@&seq_num=@gw_seqnum@&adt=@gw_adt@&aec=@gw_aec@"
...
.method private b(Lcom/google/ads/f;Ljava/lang/Boolean;)V
    ...
    .line 848
    const-string/jumbo v0, "http://e.admob.com/clk?ad_loc=@gw_adlocid@&qdata=@gw_qdata@&ad_network_id=@gw_adnetid@&js=@gw_sdkver@&session_id=@gw_sessid@&seq_num=@gw_seqnum@&nr=@gw_adnetrefresh@"
...
.method public declared-synchronized A()V
    ...
    .line 969
    const-string/jumbo v0, "Refreshing ad."
    ...
    :cond_1
    :try_start_2
    const-string/jumbo v0, "Not refreshing because the ad is not visible."
    ...
    .line 986
    :cond_3
    const-string/jumbo v0, "Tried to refresh an ad that wasn\'t an AdView."
    ...
    .line 989
    :cond_4
    const-string/jumbo v0, "Tried to refresh before calling loadAd()."
...
.method public declared-synchronized B()V
    ...
    .line 1081
    const-string/jumbo v0, "isMediationFlag is null in show() with isReady() true. we should have an ad and know whether this is a mediation request or not. "
    ...
    .line 1098
    :cond_3
    const-string/jumbo v0, "Cannot show interstitial because it is not loaded and ready."
...
.method protected declared-synchronized D()V
    ...
    .line 1135
    const-string/jumbo v0, "activity was null while trying to ping click tracking URLs."
...
.method protected declared-synchronized E()V
    ...
    .line 1175
    :cond_1
    const-string/jumbo v0, "onReceiveAd()"
...
.method public declared-synchronized a()V
    ...
    .line 333
    const-string/jumbo v0, "Disabling hardware acceleration for a banner."
...
.method public declared-synchronized a(Landroid/view/View;Lcom/google/ads/h;Lcom/google/ads/f;Z)V
    ...
    :try_start_0
    const-string/jumbo v0, "AdManager.onReceiveGWhirlAd() called."
...
.method public declared-synchronized a(Lcom/google/ads/AdRequest;)V
    ...
    :try_start_0
    const-string/jumbo v0, "v6.4.1 RC00"
    ...
    .line 569
    const-string/jumbo v0, "loadAd called after ad was destroyed."
    ...
    .line 575
    const-string/jumbo v0, "loadAd called while the ad is already loading, so aborting."
    ...
    .line 582
    const-string/jumbo v0, "loadAd called while an interstitial or landing page is displayed, so aborting"
    ...
    const-string/jumbo v1, "GoogleAdMobDoritosLife"
...
.method public declared-synchronized a(Lcom/google/ads/f;Z)V
    ...
    const-string/jumbo v1, "AdManager.onGWhirlAdClicked(%b) called."
...
.method protected declared-synchronized a(Ljava/util/LinkedList;)V
    ...
    const-string/jumbo v3, "Adding a click tracking URL: "
...
.method public declared-synchronized b(Lcom/google/ads/c;)V
    ...
    :try_start_0
    const-string/jumbo v0, "AdManager.onGWhirlNoFill() called."
...
.method protected declared-synchronized b(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Adding a tracking URL: "
...
.method protected declared-synchronized c(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Adding a manual tracking URL: "
...
.method public declared-synchronized e()V
    ...
    .line 405
    const-string/jumbo v0, "Refreshing is no longer allowed on this AdView."
...
.method public declared-synchronized f()V
    ...
    .line 415
    const-string/jumbo v0, "Disabling refreshing."
    ...
    :cond_0
    :try_start_1
    const-string/jumbo v0, "Refreshing is already disabled."
...
.method public declared-synchronized g()V
    ...
    const-string/jumbo v1, "Enabling refreshing every "
    ...
    :cond_0
    :try_start_1
    const-string/jumbo v0, "Refreshing is already enabled."
    ...
    :cond_1
    :try_start_2
    const-string/jumbo v0, "Refreshing disabled on this AdView"
    ...
    .line 445
    :cond_2
    const-string/jumbo v0, "Tried to enable refreshing on something other than an AdView."
...
.method public declared-synchronized u()V
    ...
    .line 751
    const-string/jumbo v0, "onDismissScreen()"
...
.method public declared-synchronized v()V
    ...
    :try_start_0
    const-string/jumbo v0, "onPresentScreen()"
...
.method public declared-synchronized w()V
    ...
    :try_start_0
    const-string/jumbo v0, "onLeaveApplication()"
...
.method public declared-synchronized y()V
    ...
    .line 925
    const-string/jumbo v0, "activity was null while trying to ping tracking URLs."
...
.method public declared-synchronized z()V
    ...
    .line 944
    const-string/jumbo v0, "activity was null while trying to ping manual tracking URLs."
