...
.method private a(Landroid/content/Context;Ljava/net/HttpURLConnection;)V
    ...
    .line 511
    const-string/jumbo v1, "X-Afma-drt-Cookie"
...
.method private a(Ljava/net/HttpURLConnection;I)V
    ...
    const-string/jumbo v1, "Could not get redirect location from a "
    ...
    const-string/jumbo v2, "Response content is: "
    ...
    const-string/jumbo v2, "Response message is null or zero length: "
    ...
    const-string/jumbo v1, "Invalid response code: "
...
.method private d(Ljava/net/HttpURLConnection;)V
    ...
    .prologue
    .line 208
    const-string/jumbo v0, "X-Afma-Mediation"
...
.method private e(Ljava/net/HttpURLConnection;)V
    ...
    const-string/jumbo v3, "Could not get timeout value: "
...
.method private i(Ljava/net/HttpURLConnection;)V
    ...
    const-string/jumbo v3, "Could not get refresh value: "
...
.method private k(Ljava/net/HttpURLConnection;)V
    ...
    .prologue
    .line 319
    const-string/jumbo v0, "X-Afma-Doritos-Cache-Life"
    ...
    const-string/jumbo v1, "Got bad value of Doritos cookie cache life from header: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string/jumbo v1, "X-Afma-Doritos-Cache-Life"
    ...
    const-string/jumbo v1, ". Using default value instead."
...
.method private m(Ljava/net/HttpURLConnection;)V
    ...
    const-string/jumbo v2, "Could not parse size header: "
...
.method private n(Ljava/net/HttpURLConnection;)V
    ...
    .prologue
    .line 384
    const-string/jumbo v0, "X-Afma-Disable-Activation-And-Scroll"
...
.method public run()V
    ...
    .line 463
    const-string/jumbo v1, "Received malformed ad url from javascript."
    ...
    .line 467
    const-string/jumbo v1, "IOException connecting to ad url."
    ...
    .line 471
    const-string/jumbo v1, "An unknown error occurred in AdResponseLoader."
