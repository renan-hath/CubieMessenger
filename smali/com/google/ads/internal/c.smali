...
.method public constructor <init>(Lcom/google/ads/l;)V
    ...
    .line 629
    const-string/jumbo v0, "activity was null while trying to create an AdLoader."
...
.method static a(Ljava/lang/String;Lcom/google/ads/c;Lcom/google/ads/d;)V
    ...
    .line 1041
    const-string/jumbo v0, "max-age\\s*=\\s*(\\d+)"
    ...
    const-string/jumbo v2, "Caching gWhirl configuration for: %d seconds"
    ...
    .line 1053
    const-string/jumbo v1, "Caught exception trying to parse cache control directive. Overflow?"
    ...
    const-string/jumbo v1, "Unrecognized cacheControlDirective: \'"
    ...
    const-string/jumbo v1, "\'. Not caching configuration."
...
.method private e()Ljava/lang/String;
    ...
    .line 1391
    const-string/jumbo v0, "AFMA_getSdkConstants();"
...
.method private f()Ljava/lang/String;
    ...
    .line 1404
    const-string/jumbo v0, "http://www.gstatic.com/safa/"
    ...
    :cond_0
    const-string/jumbo v0, "http://media.admob.com/"
...
.method private g()Ljava/lang/String;
    ...
    .line 1419
    const-string/jumbo v0, "<html><head><script src=\"http://www.gstatic.com/safa/sdk-core-v40.js\"></script><script>"
    ...
    :cond_0
    const-string/jumbo v0, "<html><head><script src=\"http://media.admob.com/sdk-core-v40.js\"></script><script>"
...
.method public a(Ljava/util/Map;Landroid/app/Activity;)Ljava/lang/String;
    ...
    .line 1132
    const-string/jumbo v1, "aoi_timeout"
    ...
    .line 1138
    const-string/jumbo v1, "aoi_nofill"
    ...
    const-string/jumbo v1, "afma-sdk-a-v6.4.1"
    ...
    .line 1205
    const-string/jumbo v5, "imbf"

    invoke-interface {p1, v5, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 1209
    :cond_9
    const-string/jumbo v0, "msid"
    ...
    .line 1172
    const-string/jumbo v0, "ad_frame"
    ...
    const-string/jumbo v2, "adRequestUrlHtml: "
...
.method protected a()V
    ...
    .prologue
    .line 644
    const-string/jumbo v0, "AdLoader cancelled."
...
.method protected b()V
    ...
    .line 984
    const-string/jumbo v0, "Got a mediation response with no content type. Aborting mediation."
    ...
    const-string/jumbo v1, "Got a mediation response with a content type: \'"
    ...
    const-string/jumbo v1, "\'. Expected something starting with \'application/json\'. Aborting mediation."
    ...
    .line 1016
    const-string/jumbo v1, "AdLoader can\'t parse gWhirl server configuration."
...
.method public run()V
    ...
    .line 689
    :cond_0
    const-string/jumbo v0, "adRequestWebView was null while trying to load an ad."
    ...
    .line 697
    const-string/jumbo v0, "activity was null while forming an ad request."
    ...
    .line 723
    :cond_3
    const-string/jumbo v2, "_requestUrl"
    ...
    .line 729
    :cond_4
    const-string/jumbo v2, "_activationOverlayUrl"
    ...
    .line 735
    :cond_5
    const-string/jumbo v2, "_orientation"
    ...
    .line 974
    :try_start_b
    const-string/jumbo v1, "An unknown error occurred in AdLoader."
    ...
    const-string/jumbo v2, "Caught internal exception: "
    ...
    const-string/jumbo v2, "AdLoader InterruptedException while getting the URL: "
    ...
    const-string/jumbo v1, "AdLoader timed out after "
    ...
    const-string/jumbo v1, "ms while getting the URL."
    ...
    .line 797
    const-string/jumbo v0, "AdLoader doesn\'t have a URL for the activation overlay"
    ...
    .line 839
    const-string/jumbo v0, "Not using loadUrl()."
    ...
    const-string/jumbo v2, "AdLoader InterruptedException while getting the ad server\'s response: "
    ...
    .line 814
    const-string/jumbo v0, "Request scenario: Online server request."
    ...
    .line 818
    const-string/jumbo v0, "Request scenario: Online using buffered ads."
    ...
    .line 823
    const-string/jumbo v0, "Request scenario: Offline using buffered ads."
    ...
    .line 829
    const-string/jumbo v0, "Request scenario: Offline with no buffered ads."

    invoke-static {v0}, Lcom/google/ads/util/b;->c(Ljava/lang/String;)V

    .line 830
    const-string/jumbo v0, "Network is unavailable.  Aborting ad request."
    ...
    const-string/jumbo v1, "ms while waiting for the ad server\'s response."
    ...
    const-string/jumbo v1, "Using loadUrl.  adBaseUrl: "
    ...
    const-string/jumbo v1, "Expected HTML but received "
    ...
    .line 916
    const-string/jumbo v0, "Multiple supported ad sizes were specified, but the server did not respond with a size."
    ...
    const-string/jumbo v1, "The ad server did not respond with a supported AdSize: "
    ...
    .line 931
    const-string/jumbo v0, "adSize was expected to be null in AdLoader."
    ...
    const-string/jumbo v2, "AdLoader InterruptedException while loading the HTML: "
    ...
    const-string/jumbo v1, "ms while loading the HTML."
