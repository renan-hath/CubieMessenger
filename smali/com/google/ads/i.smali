...
.method private a(Lcom/google/ads/mediation/MediationAdapter;)V
    ...
    const-string/jumbo v1, "Activity became null while trying to instantiate adapter."
    ...
    const-string/jumbo v2, " doesn\'t support the MediationInterstitialAdapter"
    ...
    const-string/jumbo v2, " doesn\'t support the MediationBannerAdapter interface"
...
.method private static a(Ljava/util/Map;)Z
    ...
    .prologue
    .line 67
    const-string/jumbo v0, "gwhirl_share_location"
    ...
    const-string/jumbo v2, "Received an illegal value, \'"
    ...
    const-string/jumbo v1, "\', for the special share location parameter from mediation server"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string/jumbo v1, " (expected \'0\' or \'1\'). Will not share the location."
...
.method public run()V
    ...
    const-string/jumbo v1, "Trying to instantiate: "
    ...
    const-string/jumbo v2, "Cannot find adapter class \'"
    ...
    const-string/jumbo v2, "\'. Did you link the ad network\'s mediation adapter? Skipping ad network."
    ...
    .line 127
    const-string/jumbo v1, "Error while creating adapter and loading ad from ad network. Skipping ad network."
