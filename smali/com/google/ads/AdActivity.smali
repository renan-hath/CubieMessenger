...
.method private e()V
    ...
    .line 913
    const-string/jumbo v0, "Disabling hardware acceleration on collapsing MRAID WebView."
    ...
    .line 974
    const-string/jumbo v0, "AdActivity is closing."
    ...
    .line 917
    const-string/jumbo v0, "Re-enabling hardware acceleration on collapsing MRAID WebView."
    ...
    :cond_9
    :try_start_1
    const-string/jumbo v0, "currentAdManager is null while trying to destroy AdActivity."
...
.method protected a(Lcom/google/ads/internal/AdWebView;ZIZZ)V
    ...
    .line 807
    const-string/jumbo v0, "Interstitial created with an AdWebView that is already in use by another AdActivity."
    ...
    .line 780
    :cond_3
    const-string/jumbo v0, "Disabling hardware acceleration on the AdActivity WebView."
    ...
    .line 794
    :cond_4
    const-string/jumbo v0, "MRAID banner was not a child of a ViewGroup."
    ...
    .line 798
    :cond_5
    const-string/jumbo v0, "Interstitial created with an AdWebView that has a parent."
...
.method protected a(Ljava/util/HashMap;Lcom/google/ads/internal/d;)V
    ...
    .line 372
    const-string/jumbo v0, "Could not get the paramMap in launchIntent()"
    ...
    const-string/jumbo v2, "Warning: Could not parse component name from open GMSG: "
    ...
    const-string/jumbo v5, "Warning: Unknown type in extras from open GMSG: "
    ...
    const-string/jumbo v1, "Warning: Could not parse flags from open GMSG: "
    ...
    const-string/jumbo v1, "Warning: Could not parse extras from open GMSG: "
    ...
    .line 475
    const-string/jumbo v0, "Tried to launch empty intent."
    ...
    const-string/jumbo v1, "Launching an intent from AdActivity: "
...
.method public getOpeningAdWebView()Lcom/google/ads/internal/AdWebView;
    ...
    .line 320
    const-string/jumbo v1, "currentAdManager was null while trying to get the opening AdWebView."
...
.method public newAdVideoView(IIII)V
    ...
    .line 539
    const-string/jumbo v0, "currentAdManager was null while trying to get the opening AdWebView."
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v1, "com.google.ads.AdOpener"
    ...
    .line 645
    const-string/jumbo v0, "Could not get the Bundle used to create AdActivity."
    ...
    :cond_5
    :try_start_1
    const-string/jumbo v0, "Could not get currentAdManager."
    ...
    const-string/jumbo v2, "custom_close"
    ...
    .line 687
    :cond_d
    const-string/jumbo v0, "Could not get the URL or HTML parameter to show a web app."
    ...
    .line 733
    const-string/jumbo v0, "Re-enabling hardware acceleration on expanding MRAID WebView."
    ...
    const-string/jumbo v2, "Unknown AdOpener, <action: "
...
.method public onWindowFocusChanged(Z)V
    ...
    .line 989
    const-string/jumbo v0, "Launcher AdActivity got focus and is closing."
