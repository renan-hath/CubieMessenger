...
.method public static a(Lcom/google/ads/c;Lcom/google/ads/internal/d;)Z
    ...
    .line 178
    const-string/jumbo v0, "InterstitialAd received a mediation response corresponding to a non-interstitial ad. Make sure you specify \'interstitial\' as the ad-type in the mediation UI."
    ...
    const-string/jumbo v3, "AdView received a mediation response corresponding to an interstitial ad. Make sure you specify the banner ad size corresponding to the AdSize you used in your AdView  ("
    ...
    const-string/jumbo v1, ") in the ad-type field in the mediation UI."
    ...
    const-string/jumbo v4, "Mediation server returned ad size: \'"
    ...
    const-string/jumbo v3, "\', while the AdView was created with ad size: \'"
    ...
    const-string/jumbo v1, "\'. Using the ad-size passed to the AdView on creation."
...
.method private a(Lcom/google/ads/h;Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "GWController: ignoring callback to "
    ...
    const-string/jumbo v1, " from non showing ambassador with adapter class: \'"
...
.method private a(Ljava/lang/String;Landroid/app/Activity;Lcom/google/ads/AdRequest;Lcom/google/ads/f;Ljava/util/HashMap;J)Z
    ...
    const-string/jumbo v2, "Interrupted while waiting for ad network to load ad using adapter class: "
    ...
    const-string/jumbo v2, "Timeout occurred in adapter class: "
...
.method private b(Lcom/google/ads/c;Lcom/google/ads/AdRequest;)V
    ...
    const-string/jumbo v1, "Looking to fetch ads from network: "
    ...
    .line 361
    const-string/jumbo v0, "Activity is null while mediating.  Terminating mediation thread."
    ...
    .line 374
    const-string/jumbo v0, "GWController.destroy() called. Terminating mediation thread."
...
.method public a(Lcom/google/ads/c;Lcom/google/ads/AdRequest;)V
    ...
    .line 129
    const-string/jumbo v0, "Mediation thread is not done executing previous mediation  request. Ignoring new mediation request"
...
.method public a(Lcom/google/ads/h;Landroid/view/View;)V
    ...
    const-string/jumbo v1, "GWController: ignoring onAdRefreshed() callback from non-showing ambassador (adapter class name is \'"
...
.method public a(Lcom/google/ads/h;Z)V
    ...
    .prologue
    .line 225
    const-string/jumbo v0, "onAdClicked()"
...
.method public c()Z
    ...
    .line 311
    :cond_0
    const-string/jumbo v0, "There is no ad ready to show."
