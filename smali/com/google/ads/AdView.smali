...
.method public constructor <init>(Landroid/app/Activity;Lcom/google/ads/AdSize;Ljava/lang/String;)V
    ...
    .line 96
    const-string/jumbo v1, "Could not initialize AdView"
...
.method private a(Landroid/app/Activity;Lcom/google/ads/AdSize;Ljava/lang/String;)V
    ...
    .line 528
    const-string/jumbo v1, "Gestures disabled: Not supported on this version of Android."
...
.method private a(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    const-string/jumbo v4, "Attribute \"adSize\" invalid: "
    ...
    .line 394
    :goto_1
    const-string/jumbo v3, "Could not initialize AdView"
    ...
    const-string/jumbo v2, "Required XML attribute \"adUnitId\" missing"
    ...
    .line 358
    const-string/jumbo v1, "loadAdOnCreate"
    ...
    .line 377
    const-string/jumbo v1, "testDevices"
    ...
    .line 379
    const-string/jumbo v2, "TEST_EMULATOR"
    ...
    const-string/jumbo v2, "AdView was initialized with a Context that wasn\'t an Activity."
...
.method private a(Landroid/content/Context;Lcom/google/ads/AdSize;Landroid/util/AttributeSet;)Z
    ...
    .line 209
    const-string/jumbo v0, "You must have AdActivity declared in AndroidManifest.xml with configChanges."
...
.method private a(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;Z)Z
    ...
    .line 409
    const-string/jumbo v0, "http://schemas.android.com/apk/lib/com.google.ads"
    ...
    const-string/jumbo v5, "Could not find resource for "
    ...
    const-string/jumbo v3, " was not a boolean: "
...
.method private b(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;Z)Ljava/lang/String;
    ...
    const-string/jumbo v4, "Could not find resource for "
...
.method private b(Landroid/content/Context;Lcom/google/ads/AdSize;Landroid/util/AttributeSet;)Z
    ...
    .line 236
    const-string/jumbo v0, "You must have INTERNET and ACCESS_NETWORK_STATE permissions in AndroidManifest.xml."
...
.method a(Ljava/lang/String;)[Lcom/google/ads/AdSize;
    ...
    .line 285
    const-string/jumbo v5, "^(\\d+|FULL_WIDTH)\\s*[xX]\\s*(\\d+|AUTO_HEIGHT)$"
    ...
    :cond_3
    const-string/jumbo v5, "SMART_BANNER"
    ...
    :cond_4
    const-string/jumbo v5, "IAB_MRECT"
    ...
    :cond_5
    const-string/jumbo v5, "IAB_BANNER"
    ...
    :cond_6
    const-string/jumbo v5, "IAB_LEADERBOARD"
    ...
    :cond_7
    const-string/jumbo v5, "IAB_WIDE_SKYSCRAPER"
...
.method protected onWindowVisibilityChanged(I)V
    ...
    const-string/jumbo v2, "onopeninapp"
    ...
    const-string/jumbo v2, "onleaveapp"
...
.method protected varargs setSupportedAdSizes([Lcom/google/ads/AdSize;)V
    ...
    .line 608
    const-string/jumbo v0, "Warning: Tried to set supported ad sizes on a single-size AdView. AdSizes ignored. To create a multi-sized AdView, use an AdView constructor that takes in an AdSize[] array."
