...
.method private addCommonParameters()V
    ...
    const-string/jumbo v4, "Session provided to a Request in un-opened state."
    ...
    const-string/jumbo v4, "Warning: Sessionless Request needs token but missing either application ID or client token."
...
.method private appendParametersToBaseUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "Unsupported parameter type for GET request: %s"
...
.method public static executeConnectionAndWait(Ljava/net/HttpURLConnection;Lcom/facebook/RequestBatch;)Ljava/util/List;
    ...
    const-string/jumbo v6, "Received %d responses while expecting %d"
...
.method private static processRequest(Lcom/facebook/RequestBatch;Lcom/facebook/internal/Logger;ILjava/net/URL;Ljava/io/OutputStream;)V
    ...
    const-string/jumbo v7, "At least one request in a batch must have an open Session, or a default app ID must be specified."
