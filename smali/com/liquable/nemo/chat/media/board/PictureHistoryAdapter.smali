.class public Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;
...
.method protected bridge synthetic canBeDisplayed(Lcom/liquable/nemo/message/model/AbstractMediaMessage;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->canBeDisplayed(Lcom/liquable/nemo/message/model/PictureMessage;)Z
...
.method protected canBeDisplayed(Lcom/liquable/nemo/message/model/PictureMessage;)Z
    .locals 2
    ...
    invoke-virtual {p1, v1}, Lcom/liquable/nemo/message/model/PictureMessage;->isSender(Ljava/lang/String;)Z
...
.method protected getMediaView(ILandroid/view/View;Landroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    .line 49
    iget-object v2, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->layoutInflater:Landroid/view/LayoutInflater;
    ...
    iget v2, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->columnCount:I

    iget-object v3, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->layoutInflater:Landroid/view/LayoutInflater;

    const v4, 0x7f030163

    new-instance v5, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter$1;

    invoke-direct {v5, p0}, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter$1;-><init>(Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;)V
    ...
    .line 72
    invoke-virtual {p0, p1, v6}, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->getMediaMessage(II)Lcom/liquable/nemo/message/model/AbstractMediaMessage;

    move-result-object v7

    check-cast v7, Lcom/liquable/nemo/message/model/PictureMessage;

    .line 74
    .local v7, "message":Lcom/liquable/nemo/message/model/PictureMessage;
    if-nez v7, :cond_1

    .line 75
    iget-object v2, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->imageLoader:Lcom/liquable/nemo/util/ImageLoader;

    new-instance v3, Lcom/liquable/nemo/message/view/TransparentDrawable;

    iget-object v4, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->activity:Lcom/liquable/nemo/chat/media/board/MediaShareBoardActivity;
    ...
    .end local v6    # "i":I
    .end local v7    # "message":Lcom/liquable/nemo/message/model/PictureMessage;
    :cond_0
    ...
    .restart local v7    # "message":Lcom/liquable/nemo/message/model/PictureMessage;
    :cond_1
    iget-object v2, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->activity:Lcom/liquable/nemo/chat/media/board/MediaShareBoardActivity;

    invoke-virtual {v2}, Lcom/liquable/nemo/chat/media/board/MediaShareBoardActivity;->getDownloadingList()Ljava/util/List;

    move-result-object v2

    invoke-virtual {v7}, Lcom/liquable/nemo/message/model/PictureMessage;->getAssetRemoteKeyPath()Lcom/liquable/nemo/storage/aws/RemoteKeyPath;
    ...
    .line 93
    invoke-virtual {v7, v5}, Lcom/liquable/nemo/message/model/PictureMessage;->getLocalKeyPath(Z)Lcom/liquable/nemo/storage/LocalKeyPath;
    ...
    .line 83
    :cond_2
    invoke-virtual {v7}, Lcom/liquable/nemo/message/model/PictureMessage;->getAssetLocalKeyPath()Lcom/liquable/nemo/storage/LocalKeyPath;
...
.method public getMessageType()Ljava/lang/Class;
    ...
    .prologue
    .line 39
    const-class v0, Lcom/liquable/nemo/message/model/PictureMessage;

    return-object v0
.end method

.method protected onMediaClicked(Lcom/liquable/nemo/message/model/PictureMessage;)V
    .locals 3
    .param p1, "message"    # Lcom/liquable/nemo/message/model/PictureMessage;

    .prologue
    .line 103
    invoke-virtual {p1}, Lcom/liquable/nemo/message/model/PictureMessage;->getAssetLocalKeyPath()Lcom/liquable/nemo/storage/LocalKeyPath;
    ...
    .line 108
    :cond_0
    iget-object v1, p0, Lcom/liquable/nemo/chat/media/board/PictureHistoryAdapter;->activity:Lcom/liquable/nemo/chat/media/board/MediaShareBoardActivity;
