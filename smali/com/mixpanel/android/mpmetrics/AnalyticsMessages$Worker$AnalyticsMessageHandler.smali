...
.method private getDefaultEventProperties()Lorg/json/JSONObject;
    ...
    .line 408
    const-string/jumbo v9, "$lib_version"

    const-string/jumbo v10, "4.2.2"
    ...
    const-string/jumbo v9, "$screen_dpi"
    ...
    .line 420
    const-string/jumbo v9, "$screen_height"
    ...
    .line 421
    const-string/jumbo v9, "$screen_width"
    ...
    .line 433
    const-string/jumbo v9, "$has_telephone"
    ...
    .line 445
    const-string/jumbo v9, "$bluetooth_enabled"
    ...
    .line 449
    const-string/jumbo v9, "$bluetooth_version"
...
.method private sendAllData(Lcom/mixpanel/android/mpmetrics/MPDbAdapter;)V
    ...
    const-string/jumbo v2, "Not flushing data to Mixpanel because the device is not connected to the internet."
    ...
    const-string/jumbo v2, "Sending records to Mixpanel"
...
.method private sendData(Lcom/mixpanel/android/mpmetrics/MPDbAdapter;Lcom/mixpanel/android/mpmetrics/MPDbAdapter$Table;[Ljava/lang/String;)V
    ...
    .line 364
    const-string/jumbo v18, "MixpanelAPI"

    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v20, "Response was null, unexpected failure posting to "
    ...
    const-string/jumbo v19, "Not retrying this batch of events, deleting them from DB."
    ...
    const-string/jumbo v20, "Successfully posted to "
    ...
    const-string/jumbo v20, "Response was "
    ...
    const-string/jumbo v20, "Out of memory when posting to "
    ...
    const-string/jumbo v19, "UTF not supported on this platform?"
    ...
    const-string/jumbo v20, "Cannot interpret "
    ...
    const-string/jumbo v20, " as a URL."
    ...
    const-string/jumbo v20, "Cannot post message to "
    ...
    const-string/jumbo v19, "Retrying this batch of events."
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v10, "Changing flush interval to "
    ...
    const-string/jumbo v9, "Flushing queue due to bulk upload limit"
    ...
    const-string/jumbo v10, "Setting fallback to "
    ...
    const-string/jumbo v8, "MixpanelAPI"

    const-string/jumbo v9, "Worker threw an unhandled exception"
    ...
    const-string/jumbo v10, "Mixpanel will not process any more analytics messages"
    ...
    const-string/jumbo v9, "Queuing people record for sending later"
    ...
    const-string/jumbo v9, "Queuing event for sending later"
    ...
    const-string/jumbo v10, "Exception tracking event "
    ...
    const-string/jumbo v9, "Flushing queue due to scheduled or forced flush"
    ...
    const-string/jumbo v9, "Installing a check for surveys and in app notifications"
    ...
    const-string/jumbo v10, "Worker received a hard kill. Dumping all events and force-killing. Thread id "
    ...
    const-string/jumbo v10, "Unexpected message received by Mixpanel worker: "
    ...
    const-string/jumbo v10, "Queue depth "
    ...
    const-string/jumbo v10, " - Adding flush in "
    ...
    const-string/jumbo v10, "Could not halt looper"
