...
.method public getUrls(Landroid/content/Context;[Ljava/lang/String;)[B
    ...
    const-string/jumbo v6, "MixpanelAPI"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "Cannot interpret "
    ...
    const-string/jumbo v8, " as a URL."
    ...
    const-string/jumbo v8, "Cannot get "
    ...
    const-string/jumbo v8, "Out of memory when getting to "
...
.method public isOnline(Landroid/content/Context;)Z
    ...
    const-string/jumbo v6, "ConnectivityManager says we "
    ...
    const-string/jumbo v5, "Don\'t have permission to check connectivity, assuming online"
...
.method public performRequest(Ljava/lang/String;Ljava/util/List;)[B
    ...
    const-string/jumbo v12, "MixpanelAPI"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v14, "Attempting request to "
    ...
    const-string/jumbo v13, "Failure to connect, likely caused by a known issue with Android lib. Retrying."
